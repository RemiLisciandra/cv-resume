<template>
  <div>
    <h2 class="text-base/7 font-semibold text-primary-400 flex items-center gap-2">
    ...
    <!-- Métadonnées (âge et localisation) -->
    <div class="mt-4">
      <HeroProfileMetadata 
...
/**
 * Composant d'affichage des informations de profil
 */
